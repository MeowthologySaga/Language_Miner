...
| `docs/site/assets/community/*` | Local catalog copies of the three developer-official game cover images | Exact tagged sources: `abyss-summoner@v0.1.2/assets/thumbnail.webp`, `Drillheart_Defense@v0.2.0/src/assets/ui-menu-bg.png`, `Cat_Odyssey@v0.1.1/cartridge/assets/thumbnail.webp` | Byte-for-byte copies from the immutable public game tags; no crop, overlay, recompression, remote hotlink, or user tracking | Same `LicenseRef-Meowthology-Official-Builtin` media terms recorded for each official game above; Cat Odyssey cover itself does not contain the separately restricted narration, but remains under the official media terms | Catalog identifies each title as a MeowthologySaga developer-official game and links the pinned source and release | **Confirmed**; SHA-256: Abyss `7c6d40ce9b20ebcf86bee6ad6f71834e195830cc55eaeab62eacad4b5fda209a`, Drillheart `da91c25ae7b65d30826297ba0db518ba7b795b5a5c038237697c5accf5e8c3fa`, Cat Odyssey `b69111fef39152244f380aaa68a896fbf405fe0b8b791ccbb2179a823f39177e` |
| `docs/site/assets/app-images/{ko,en}/home-*.webp` | Homepage screenshots for the live Web Reader, Alice Document Reader, self-contained office dialogue video, and the front/back of all three card types | Language Miner QA profile; live reading text from Project Gutenberg eBook #11; office scene from the confirmed `public/samples/listening/onboarding-office-send.png` asset | Deterministic Electron capture by `scripts/qa-homepage-screenshots-electron.cjs`; the temporary video uses on-device Windows TTS and remains only under ignored `debug/qa` output | Application UI under GPL-3.0-only; Alice text public domain in the United States with Gutenberg terms retained in the tracked source; office scene basis recorded below; no generated WAV or MP4 is redistributed | Screenshot captions identify Alice / Project Gutenberg where relevant | **Confirmed**; fresh profile contains no personal account data or API key, and the capture runner scans visible text before publication |
